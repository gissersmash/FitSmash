...
export const t = {
  fr: {
    ...
    health: { title: "Suivi Santé", addEntry: "Ajouter", weight: "Poids (kg)", date: "Date", save: "Enregistrer", noData: "Aucune donnée", history: "Historique", chart: "Graphique Santé", table: "Tableau Suivi" },
  ...
  en: {
    ...
    health: { title: "Health Tracking", addEntry: "Add", weight: "Weight (kg)", date: "Date", save: "Save", noData: "No data", history: "History", chart: "Health Chart", table: "Tracking Table" },
